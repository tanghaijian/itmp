...
function createWorseSystemTable(data){
	$("#worseSystemTable").bootstrapTable('destroy');
    $("#worseSystemTable").bootstrapTable({
        queryParamsType:"",
        data:data,
        columns : [
        {
