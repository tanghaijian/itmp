        ...
        var DataGrid = function(options, $this) {
            ...
            if (options.editGrid) {
                ...
                if (options.editGridInputForm && options.editGridInputForm.length > 0 && options.editGridInputFormListName != "" && options.editGridInputFormListAttrs != "") {
                    options.editGridInputForm.submit(function() {
                        updateListFieldName(options.editGridInputFormListName, options.editGridInputFormListAttrs)
                    })
                }
            }
            ...
            function refreshTreeChildren(rowid, currentRowid) {
                ...
                if (isRoot(rowid)) {
                    ...
                    if (rowid != "") {
                        dataGrid.find("#" + rowid + " .treeclick").dblclick()
                    }
                }
            }
...
function pageHtmlControl(b) {
    ...
    a.push('<li class="disabled controls" title="' + $.jgrid.pageTitle + '">' + $.jgrid.extend.pageLabelA + " ");
        ...
        a.jgrid.extend({
            getIdsByLevel: function(b) {
                ...
                this.each(function() {
                    ...
                    var l = g.p.expColInd
                        , k = g.p.treeReader.expanded_field
                        , e = g.p.treeReader.leaf_field
                        , d = g.p.treeReader.level_field
                        , m = g.p.treeReader.icon_field
                        , j = g.p.treeReader.loaded;
                    var h = g.p.data;
        ...
        a.jgrid.extend({
            setComplexHeaders: function(b) {
                ...
                return this.each(function() {
                    ...
                    var K = this, p = l.defaultStyle === undefined ? true : l.defaultStyle, G, E, n, J, k, d, F, x, M, u, c, C, r = 0, H = 0, A = false, B, v, w, f, y = K.p.colModel, D = y.length, t = K.grid.headers, h = a("table.ui-jqgrid-htable", K.grid.hDiv), m = h.children("thead").children("tr.ui-jqgrid-labels:last").addClass("jqg-second-row-header"), e = h.children("thead"), s, q, o = h.find(".jqg-first-row-header");
                    if (o[0] === undefined) {
                        o = a("<tr>", {
                            role: "row",
                            "aria-hidden": "true"
                    ...
                    J = a("<tr>", {
                        role: "rowheader"
                    }).addClass("ui-jqgrid-labels jqg-four-row-header");
                    for (G = 0; G < D; G++) {
                        d = t[G].el;
                        F = a(d);
                        E = y[G];
                        ...
                        a("<th>", {
                            role: "gridcell"
                        }).css(x).addClass("ui-first-th-" + K.p.direction).appendTo(o);
                        d.style.width = "";
                        c = I(E.name, j);
                        if (c >= 0) {
                            B = j[c];
            ...
            createFrozenHtable: function(e, g) {
                var P = this[0], I = P.p.complexHeader, m = I.complexHeaders, q = m.defaultStyle, k = m.threeLevel, j = m.twoLevel, H = P.p.id, A = P.p.colModel, F = e + 1, t = P.grid.headers, r = 0, L = 0, C = false, K, G, z, d, J, y, B, R, l, D, u, b, E, v, w, h, c = P.grid.fhDiv.height(), M = a("<table class='ui-jqgrid-htable' style='width:1px;height:" + c + "px' role='grid' aria-labelledby='gbox_" + H + "' cellspacing='0' cellpadding='0' border='0'></table>"), f = a("<thead></thead>"), p = a("<tr>", {
                    role: "row",
                    "aria-hidden": "true"
                }).addClass("jqg-first-row-header").css("height", "auto"), n = a("<tr>", {
                    role: "rowheader"
                }).addClass("ui-jqgrid-labels jqg-second-row-header"), o = a("<tr>", {
                    role: "rowheader"
                }).addClass("ui-jqgrid-labels jqg-third-row-header"), O = a("<tr>", {
                    role: "rowheader"
                }).addClass("ui-jqgrid-labels jqg-four-row-header"), N = function(V, T) {
                    var S = 0
                        , U = T.length;
                    for (; S < U; S++) {
                ...
                for (K = 0; K < F; K++) {
                    ...
                    a("<th>", {
                        role: "gridcell"
                    }).css(z).addClass("ui-first-th-" + P.p.direction).appendTo(p);
                    b = N(G.name, k);
                    if (b >= 0) {
                        D = k[b];
