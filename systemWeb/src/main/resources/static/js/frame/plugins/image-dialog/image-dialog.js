		...
		exports.fn.imageDialog = function() {
            ...
            if (editor.find("." + dialogName).length < 1)
            {
				...
				fileInput.bind("change", function() {
                     var fileName  = fileInput.val().split('.')[1];
                     var files = $('[name="editormd-image-file"]').get(0).files[0];
                     ...
                     reader.onload = function(e) {
                    	 ...
                    	 $.ajax({
                             ...
                             success: function (msg) {
                                 if(msg.code == 1){
                                     let url = 'http://' + document.location.host +'/projectManage/systemDirectoryDocumentOperate/queryPic/' + msg.s3Key;
