...
public class ReportUiFavorite implements Serializable{
    ...
    private String filterName;  //收藏名
    
    private Integer lastUseFlag;//是否选中
    ...
    public Integer getLastUseFlag() {
		return lastUseFlag;
	}

	public void setLastUseFlag(Integer lastUseFlag) {
		this.lastUseFlag = lastUseFlag;
	}
