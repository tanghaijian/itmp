package cn.pioneeruniverse.project.dao.mybatis.programProject;
...
public interface ProgramProjectMapper {
     ...
     * @return
     */
    List<ProjectPlanNewDTO> selectEstimateRemainWorkloadNewList(@Param("currentDate") String currentDate,@Param("programId") Integer programId,@Param("sprintId") List<Long> sprintId);
