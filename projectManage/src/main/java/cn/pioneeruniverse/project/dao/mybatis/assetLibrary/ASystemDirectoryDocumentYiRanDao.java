...
public interface ASystemDirectoryDocumentYiRanDao {
     ...
     * @return
     */
    Integer updateDocumentVersionById(@Param("systemDirectoryDocumentId") Long systemDirectoryDocumentId,@Param("lastUpdateDate") Timestamp lastUpdateDate,@Param("lastUpdateId") Long lastUpdateId);
