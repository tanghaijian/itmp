...
public interface TblSystemDirectoryDocumentMapper extends BaseMapper<TblSystemDirectoryDocument> {
    ...
    List<Map<String, Object>> getChapterRelation(String chapterId);
    
    TblSystemDirectoryDocument getAllDocChapters(@Param("systemDirectoryDocumentId") Long systemDirectoryDocumentId);
