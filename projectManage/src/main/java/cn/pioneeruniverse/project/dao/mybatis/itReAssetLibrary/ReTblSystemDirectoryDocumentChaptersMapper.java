...
public interface ReTblSystemDirectoryDocumentChaptersMapper {
	...
	**/
	...
	List<TblSystemDirectoryDocumentChapters> getChaptersByRequirementFeatureId(@Param("featureId") Long featureId);
	/**
	 *@author liushan
	...
	TblSystemDirectoryDocumentChapters getMaxVersionStatusByIdAndFeatureId(@Param("id") Long id,@Param("featureId") Long featureId);
