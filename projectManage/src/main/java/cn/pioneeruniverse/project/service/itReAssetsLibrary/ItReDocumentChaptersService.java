...
public interface ItReDocumentChaptersService {
	/**
	 * 根据文档id获取章节树
	 * 
	 ...
	 * @param tblSystemDirectoryDocumentChaptersRelation
	 */
	void insertChaptersRelation(TblSystemDirectoryDocumentChaptersRelation tblSystemDirectoryDocumentChaptersRelation,String chaptersIdStr,String currentUserAccount,HttpServletRequest request) throws Exception;
	 ...
	 * liushan
	 */
    Map<String,Object> getVersionContrast(Long systemDirectoryDocumentId,String requirementCode,String featureCode, HttpServletRequest request, HttpServletResponse response) throws Exception;
}
