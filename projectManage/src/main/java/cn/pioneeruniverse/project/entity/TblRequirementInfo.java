...
import cn.pioneeruniverse.project.vo.RequirementVo;
...
public class TblRequirementInfo extends RequirementVo{
	...
	/*基本信息*/
	private	Long itcdRequirementId;	//IT全流程需求ID
	...
	/*重点需求相关*/
	private	String importantRequirementStatus;		//是否重点需求(1=是，0=否)
	private	String importantRequirementType;		//重点需求类型(数据字典)
	private	String importantRequirementDelayStatus;	//重点需求是否延误(1=是，0=否)
	...
	/*其他信息*/
	private	String hangupStatus;	//需求是否挂起(1=是；0=否)
	...
	private	String requirementProperty;	//需求性质(数据字典)
	private	String requirementClassify;	//需求分类(数据字典)
	private	String requirementSubdivision;	//细分类型(数据字典)
	...
	private String requirementIds;//关联需求
	private String fieldTemplate;//扩展字段
	private List<TblRequirementSystem> list; //系统模块
	@Transient
	private List<TblRequirementFeature> reqfeaList; //需求下的开发任务
	
	public Long getItcdRequirementId() {
		return itcdRequirementId;
	}
	public void setItcdRequirementId(Long itcdRequirementId) {
		this.itcdRequirementId = itcdRequirementId;
	}
	...
	public List<TblRequirementSystem> getList() {
		return list;
	}
	public void setList(List<TblRequirementSystem> list) {
		this.list = list;
	}
	@Override
	public String toString() {
		return "TblRequirementInfo [requirementName=" + requirementName + ", requirementCode=" + requirementCode
				+ ", requirementStatus=" + requirementStatus + ", requirementSource=" + requirementSource
				+ ", requirementType=" + requirementType + "]";
	}
	public List<TblRequirementFeature> getReqfeaList() {
		return reqfeaList;
	}
	public void setReqfeaList(List<TblRequirementFeature> reqfeaList) {
		this.reqfeaList = reqfeaList;
	}
