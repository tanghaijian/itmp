						...
						return new TlsAuthentication() {
							...
							private KeyStore _loadKeyStore() throws Exception {
								...
								try {
									...
									String trustStoreType = System.getProperty("javax.net.ssl.trustStoreType") != null
											? System.getProperty("javax.net.ssl.trustStoreType")
											: KeyStore.getDefaultType();
									String trustStoreProvider = System
											.getProperty("javax.net.ssl.trustStoreProvider") != null
									...
									if (trustStoreType.length() != 0) {
										...
										String str5 = System.getProperty("javax.net.ssl.trustStorePassword") != null
